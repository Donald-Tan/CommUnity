    ...
    >
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            <Image
              source={
                focused
                  ? require("@/assets/images/nav bar/icons8-walking-50.png")
                  : require("@/assets/images/nav bar/icons8-walk-50.png")
              }
              style={{ width: 28, height: 28 }}
            />
          ),
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            <Image
              source={
                focused
                  ? require("@/assets/images/nav bar/icons8-connect-30.png")
                  : require("@/assets/images/nav bar/icons8-connect-50.png")
              }
              style={{ width: 28, height: 28 }}
            />
          ),
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            <Image
              source={require("@/assets/images/nav bar/icons8-test-account-48.png")}
              style={{ width: 28, height: 28 }}
            />
          ),
        }}
